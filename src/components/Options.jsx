...
export default function Options({ selectedOptions, onToggle, nextStep, prevStep, basePrice }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4 mt-6">
        <button onClick={prevStep} className="border py-3 rounded hover:bg-gray-100 font-medium">Retour</button>
        <button onClick={nextStep} className="bg-orange-500 text-white py-3 rounded font-bold shadow-md hover:bg-orange-600">Aller au Paiement</button>
      </div>
    </div>
  );
}